...
qthelp:
	...
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/MScThesis.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/MScThesis"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/MScThesis"
	@echo "# devhelp"
