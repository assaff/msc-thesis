...
receptor, and form a thick web [ORA:??] of hydrogen bonds with the interface
...
[ORA: change the wording: CV1-x instead of fold 0-y.... "Luck" is not the word usually used in this case (indeed if you get 0.5 you are not lucky): you should use the word "Random" - this is the accepted term..]
...
We examined multiple configurations of the SVM to optimize recall and
precision on training sets, obtaining performance data for each.
